    ...
    return (
        <section>
            <div className='grid grid-cols-1 gap-6 my-10 lg:grid-cols-3'>
             ...
             {
                 appoinmentOption.map(option => <ShowOption key={option._id} option={option} setAppoinmentOption={setAppoinmentOption}></ShowOption>)
             }
         </div>
        ...
        <div className="card w-96 bg-slate-100 text-primary-content shadow-2xl">
            <div className="card-body text-center">
                ...
                <div className="card-actions justify-center ">
                    ...
                    <label htmlFor="my-modal-3" className="btn bg-secondary border-0 text-md text-white">Book Appointment</label>
                </div>
            </div>
        </div>
    )
