        ...
        <section className='h-screen flex justify-center items-center'>
            ...
            <form onSubmit={handleSubmit(handleLogin)} className=" rounded-xl shadow-xl bg-white shadow-xl text-black w-96 px-7 ">
                ...
                <div className="form-control">
                    ...
                    <input type="text" {...register("Email")} className="input input-bordered w-full max-w-xs  focus: bg-white text-black " />
                </div>
                ...
                <div className="form-control">
                    ...
                    <input type="text" {...register("password", {required: "Email Address is required"}) } className="input input-bordered w-full max-w-xs border-2 focus: bg-white text-black " />
