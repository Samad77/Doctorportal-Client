...
const SignUp = () => {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit((data) => setData(JSON.stringify(data)))} className="bg-gray-600 w-96 mx-auto text-white rounded-xl px-7 py-10">
                ...
                <p className=" mx-auto mb-2">
                        <span className="  text-white text-center">If you have an account ? <Link to="/login" className='text-primary'>Please Sign In</Link></span>
                </p>
                <p>{data}</p>
