...
const SignUp = () => {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit()} className="bg-white w-96 mx-auto text-black rounded-xl px-7 py-10">
                ...
                <div>
                    ...
                    <input {...register("password")} placeholder="Password" type="password" className="input input-bordered input-md w-full bg-white" />
                </div>
