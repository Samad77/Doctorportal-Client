        ...
        <div>
            ...
            <form onSubmit={handleSubmit(handleSubmit(handleRegister))} className="bg-white w-96 mx-auto text-black rounded-xl px-7 py-10">
                ...
                <div>
                    ...
                    <input {...register("password", {required: "Name is required for sign up"})} placeholder="Password" type="password" className="input input-bordered input-md w-full bg-white" />
                </div>
